      ...
      <div class="row">
          ...
          <ul class="col-10 list_category__li">
              ...
              <li class=" col-2 col-float">
                  <a href="{{url('/category/')}}/{{$slug}}/{{$row_category->category_id}}"><div class="vertical_tiles"></div>{{$row_category->category_title}}</a>
                 ...
                 <li>
                 <a href="{{url('/category_branch/')}}/{{$slug}}/{{$row_category_branch->category_id}}">{{$row_category_branch->category_title}}</a>
                 </li>
                  @endif
                  @endforeach
                 </ul>
