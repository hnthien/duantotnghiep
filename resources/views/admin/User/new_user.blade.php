...
@section('admin','Quản lý người dùng - New user')
@section('content')
<main class="col-10 background-white">
    <section class="section col-padding  ">
        <div class="row popular-post ">
            <h1 class="col-12 col-center" style="font-size: 30px;">Thêm Người Dùng</h1>
        </div>
        ...
        <form method="GET">
            ...
            <div class="row col-3">
                <button class="btn background-greed">Đăng Ký</button>
            </div>
