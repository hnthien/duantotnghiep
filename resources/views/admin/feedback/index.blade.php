...
<main>
    ...
    <section>
        <div class="col-margin--bottom">
            ...
            <hr>
            <span style="font-size: 12px; font-weight: bold;">Phản hồi <i class="fas fa-angle-right"></i>Quản lý phản
                hồi</span>
        </div>
        <div class="row">
        ...
        <table class="popular-post col-padding">
            ...
            <tr id='not_seen_box'>
                ...
                <td>@if($row->feedback_status == 0)<span style="color: red;"><i title="chưa xem"
                            class="fas fa-eye"></i>Chưa xem</span>@endif</td>
                ...
                <td>
                    ...
                    <p>@php echo substr($row->created_at ,10,3).' giờ '.substr($row->created_at ,14,2).' phút' @endphp
                    </p>
                </td>
                <td><a href="{{url('/admin/feedback/detail_feedback')}}/{{$row->feedback_id}}"><button
                            class="btn-admin background-blue"><i class="fas fa-edit"></i></button></a></td>
            </tr>
            @endforeach
            ...
            <tr id='watched_box'>
                <td>{{$row->feedback_id}}</td>
                <td>@if($row->feedback_status == 0)<span style="color: red;">Chưa xem</span>@else<span
                        style="color:green;"><i title="đã xem" class="fas fa-eye"></i>Đã Xem</span>@endif</td>
                <td>{{$row->feedback_title}}</td>
                ...
                <td class="col-2 "><a href="{{url('/admin/feedback/detail_feedback')}}/{{$row->feedback_id}}"><button
                            class="btn-admin background-blue"><i class="fas fa-edit"></i></button></a></td>
        ...
        <div id='not_seen_box' style="position: relative;left: 40%;text-align: center;width:20%">
            {!!$not_seen->links()!!}</div>
        <div id='watched_box' style="position: relative;left: 40%;text-align: center;width:20%">{!!$watched->links()!!}
        </div>
