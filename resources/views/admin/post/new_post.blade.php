...
<main>
    <section class="section ">
        <div class="col-margin--bottom">
            ...
            <hr>
            <span style="font-size: 12px; font-weight: bold;">Bài viết <i class="fas fa-angle-right"></i>Thêm bài viết
                mới</span>
        </div>
        <form method="POST" action="{{url('admin/post/create_post')}}" enctype="multipart/form-data">
            ...
            <div class="popular-post col-padding">
                ...
                <div class="row">
                    <div class="col-6">
                        <h3>Mô Tả:</h3>
                        <textarea class="input" type="text" name="post_intro"
                            rows="14">{{ old('post_intro') }}</textarea>
                    ...
                    <div class="col-6">
                        ...
                        <div class="form__input box_input col-margin--top">
                            ...
                            <div class="file-upload">
                                <button class="btn background-gray col-border--none" type="button"
                                    onclick="$('.file-upload-input').trigger( 'click' )">Add Image</button>

                                <div class="image-upload-wrap">
                                    <input class="file-upload-input" name="post_image" id="images_user"
                                        value="{{ old('post_image') }}" type='file' onchange="readURL(this);" />
                                    <div class="drag-text">
                ...
                <ul style="margin:0px" class="col-3 col-float">
                    <li style="padding:10px">
                        <input type="radio" name="category_id" class="selectbox"
                            value="{{$row_categorys->category_id}}" />{{$row_categorys->category_title}}
                        <ul style="margin-left: 15px;">
                            ...
                            <li style="padding:5px">
                                <input type="radio" name="category_id" class="selectbox"
                                    value="{{$row_categorys_branch->category_id}}" />{{$row_categorys_branch->category_title}}
                            </li>
                            @endif
                            @endforeach
                        </ul>
            ...
            <div class="popular-post col-padding">
                <h3>Nội Dung:</h3>
                <textarea id="post_content" name="post_content" cols="30"
                    rows="100">{{ old('post_content') }}</textarea>
                ...
                <br>
                <input type="checkbox" name="post_status" id="checked-changes" class="selectbox" value="" />Lưu bản
                nháp
            </div>
            <br>
            <div class="row col-4">
