...
@section('admin','Quản lý bài viết - Tất cả bài viết của tôi ')
@section('content')
<script>
...
<main>
    <section>
        <div class="col-margin--bottom">
            ...
            <hr>
            <span style="font-size: 12px; font-weight: bold;">Bài viết <i class="fas fa-angle-right"></i>Quản lý bài viết <i class="fas fa-angle-right"></i>Tất cả bài viết của tôi</span>
        </div>
        <div class="row">
            <div class="col-2">
        ...
        <div class="row">
            <div class="col-3">
                <p id="is_approved_p" class="color-light-gray" style="font-size:12px;">Tất cả bài viết của tôi</p>
            </div>
            <div class="col-6"></div>
            <div class="col-3">
