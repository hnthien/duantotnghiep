...
@section('admin','Quản lý bài viết - >Bài viết của tôi chưa được phê duyệt - T20 News')
@section('content')
<script>
...
<main>
    <section>
        <div class="col-margin--bottom">
            ...
            <hr>
            <span style="font-size: 12px; font-weight: bold;">Bài viết <i class="fas fa-angle-right"></i>Quản lý bài viết <i class="fas fa-angle-right"></i>Bài viết của tôi chưa được phê duyệt</span>
        </div>
        <div class="row">
            <div class="col-2">
