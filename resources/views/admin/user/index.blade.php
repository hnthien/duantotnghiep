...
<main>
    <section class="section">
        <div class="col-margin--bottom">
            ...
            <hr>
            <span style="font-size: 12px; font-weight: bold;">Người dùng <i class="fas fa-angle-right"></i>Quản lý tài
                khoản</span>
        </div>
        <div class="row">
            ...
            <form class="col-12" method="POST">
                ...
                <div class="row">
                    <div class="col-2 col-margin--bottom">
                        <button type="submit"
                            onclick="return window.confirm('Đại ca có chắc muốn đuổi tất cả bọn nó ra khỏi hội !');"
                            formaction="{{url('admin/user/delete_all')}}" class="btn background-red">Delete all
                            select</button>
                    </div>
        ...
        <tr>
            ...
            <td>{{$row->id}}</td>
            <td>
                <img src="{{ URL::asset('images/user') }}/{{$row->images_user}}"
            ...
            <td><button onclick="return window.confirm('Đại ca muốn đuổi thằng  này chứ !');"
                    formaction="{{url('admin/user/delete')}}/{{$row->id}}" class="btn-admin background-red"><i
                        class="fas fa-trash"></i></button></td>
            <td><button formaction="{{url('admin/user/edit')}}/{{$row->id}}" class="btn-admin background-blue"><i
