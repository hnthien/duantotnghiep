                                    ...
                                    <div class="comment-main-level row">
                                        ...
                                        <div class="comment-box col-11">
                                            <div class="comment-head">
                                                ...
                                                <span>{{$datec}}</span>
                                                @if (Auth::check())
                                                <button id="reply{{$cmt->comment_id}}" class="col-margin-left col-border--none color-light-gray">Trả lời</button>
                                       ...
                                       <div style="margin-left:40px; box-sizing: border-box;">
                                            <form   id="form_comment_branch{{$cmt->comment_id}}" action="{{url('admin/comment/create_comment_branch')}}/{{$cmt->comment_id}}" method="post">
                                                @csrf                                                   
                                                        ...
                                                        <button type="submit" class=" col-margin--top btn-submit btn-style">Post Comment</button>
